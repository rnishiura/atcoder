/*
Problem: https://atcoder.jp/contests/abc165/tasks/abc165_c
Author: rnishiura
Date: 23-01-09
Description:
brute force search for non-decreasing permutation with repetition 
with size n is faster enough than O(n^n)
*/
