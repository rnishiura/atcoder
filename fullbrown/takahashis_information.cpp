...
void solve() {
  ...
  rep(i, 3) {
    rep(j, 3) {
      if(a[(i+1)%3][j]-a[i][j]==a[(i+1)%3][(j+1)%3]-a[i][(j+1)%3] && a[(i+1)%3][(j+1)%3]-a[i][(j+1)%3]==a[(i+1)%3][(j+2)%3]-a[i][(j+2)%3]) continue;
      print("No");
      // print2(i, j);
      return;
    }
  ...
  rep(i, 3) {
    rep(j, 3) {
      if(a[j][(i+1)%3]-a[j][i]==a[(j+1)%3][(i+1)%3]-a[(j+1)%3][i] && a[(j+1)%3][(i+1)%3]-a[(j+1)%3][i]==a[(j+2)%3][(i+1)%3]-a[(j+2)%3][i]) continue;
      print("No");
      // print2(i, j);
      return;
    }
